...
Create the environment and initialise the Github repository in the source folder. </br></br>
...
Further, create  the GitHub repo with the README.md file, download the Jupyter Notebook and all the necessary libraries, and open the Elon Musk's tweets.ipynb file for the analysis.  </br></br>
Please install the Jupyter notebook on your local machine in order to open the file.</br>
You can find the instructions here (https://jupyter.org/install.html).  </br></br>
